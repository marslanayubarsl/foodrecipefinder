          ...
          <div>
            <div className="flex items-center space-x-2 mb-6">
              <svg className="w-10 h-10" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M10 24C10 24 4 34 4 44C4 54 14 56 32 56C50 56 60 54 60 44C60 34 54 24 54 24H10Z" fill="url(#footer-bowl-gradient)" />
                ...
                {/* Gradient definition */}
                <defs>
                  <linearGradient id="footer-bowl-gradient" x1="4" y1="24" x2="60" y2="56" gradientUnits="userSpaceOnUse">
